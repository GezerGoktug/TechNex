  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="grid sm:grid-cols-3 flew-wrap my-4 font-bold "
      >
        <div className="flex flex-col gap-2 items-center py-12 sm:py-6  text-purple-700 text-5xl md:text-7xl ">
          <TbWorldDownload />
          <h6 className=" text-xl md:text-2xl lg:text-3xl text-gradient-b from-violet-300 to-purple-700">
            150K+ Download
          </h6>
        </div>
        <div className="border-y-2  sm:border-y-0 sm:border-x-2 border-violet-500 border-dashed flex flex-col gap-2 items-center py-12 sm:py-6  text-yellow-500 text-5xl md:text-7xl ">
          <FaStar />
          <h6 className=" text-xl md:text-2xl lg:text-3xl text-gradient-b from-yellow-300 to-yellow-700">
            4.5 Rating
          </h6>
        </div>
        <div className="flex flex-col gap-2 items-center py-12 sm:py-6  text-slate-700 text-5xl md:text-7xl ">
          <BiCommentDetail />
      ...
      <div className="flex flex-col items-center gap-y-4 sm:flex-row mt-6">
        <motion.div
          variants={fadeInLeft}
          whileInView="open"
          initial="close"
